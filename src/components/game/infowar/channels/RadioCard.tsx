  ...
  return (
    <div className="border border-[var(--color-tactical-border)] rounded p-2 bg-[var(--color-tactical-dark)]">
      <div className="flex items-center gap-2 mb-1">
        <span className="text-[10px] bg-[var(--color-terminal-amber)] text-[var(--color-tactical-dark)] px-1 rounded font-bold">
          {post.persona.avatar}
        </span>
        <span className="text-[10px] text-[var(--color-terminal-amber)] uppercase tracking-wider">
          RADIO INTERCEPT
        </span>
