  ...
  return (
    <div className="border-l-2 border-[var(--color-terminal-red)] bg-[var(--color-tactical-dark)] px-2 py-1.5">
      <div className="flex items-center gap-2 mb-1">
        <span className="text-[10px] bg-[var(--color-terminal-red)] text-[var(--color-tactical-dark)] px-1 font-bold">
          {post.persona.avatar}
        </span>
        <span className="text-[10px] text-[var(--color-terminal-red)] uppercase tracking-wider">
          {post.persona.name}
        </span>
