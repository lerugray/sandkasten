...
export function TweetCard({ post, age }: TweetCardProps) {
  return (
    <div className="border border-[var(--color-tactical-border)] rounded p-2">
      <div className="flex items-center gap-2 mb-1">
        <span className="text-[10px] bg-[var(--color-terminal-blue)] text-[var(--color-tactical-dark)] px-1 rounded font-bold">
          {post.persona.avatar}
        </span>
