  ...
  return (
    <div className="text-xs space-y-2">
        ...
        <div className="flex gap-1">
          ...
          {orders.waypoints.length > 0 && (
            <button
              ...
              className="px-2 py-1 rounded text-[10px] border border-[var(--color-tactical-border)] text-[var(--color-terminal-red)] hover:border-[var(--color-terminal-red)] cursor-pointer"
            >
              CLEAR
            </button>
          )}
      ...
      <div>
        ...
        {orders.radarActive && (
          <span className="text-[10px] text-[var(--color-tactical-text-dim)] ml-2">
